...
#PlotVoltage
plot( power_feb$Voltage~power_feb$DateTime,type = "l", ylab = "voltage",xlab = "")

#PlotReactive
plot( power_feb$Global_reactive_power~power_feb$DateTime,type = "l", ylab = "Global_reactive_power",xlab = "")
